...
class ExtraGeometrieTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.extraGeometrie.field_values(),
                         [None,'nl.imkl-nbact1.xg00009','2015-10-19T09:30:47.0Z',
...
155052.000 388010.000))'])
    ...
    def test_csv_header(self):
        self.assertEqual(self.extraGeometrie.csv_header(),
                         'klicnummer;id;registratiedatum;vervaldatum;network_id;thema;\
object;geometry')
...
class GraafpolygoonTestCase(unittest.TestCase):
    ...
    def test_field_names(self):
        self.assertEqual(self.imkl_obj.field_names(),
                         ['klicnummer', 'id', 'registratiedatum','vervaldatum','ordernummer',
                          'positienummer','referentie',
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-KA0000._Graafpolygoon_18G007160',
...
class GebiedsinformatieAanvraagTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         ['18G007160','nl.imkl-KA0000._GebiedsinformatieAanvraag_18G007160',
                          '2018-07-19T12:02:03.000+02:00',None,'9806758830',
                          '0000000010','Tbv Klicviewer - Graaf',
...
class AanduidingEVTestCase(unittest.TestCase):
    ...
    def test_field_names(self):
        self.assertEqual(self.imkl_obj.field_names(),
                         ['klicnummer','id', 'registratiedatum', 'vervaldatum', 'label',
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.EV1','2001-12-17T09:30:47.00+01:00',
                          None,
...
class BelanghebbendeTestCase(unittest.TestCase):
    ...
    def test_field_names(self):
        self.assertEqual(self.imkl_obj.field_names(),
                         ['klicnummer','id','registratiedatum','vervaldatum','bronhoudercode',
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact2._Belanghebbende_18G007160-1',
...
class BelangTestCase(unittest.TestCase):
    ...
    def test_field_names(self):
        self.assertEqual(self.imkl_obj.field_names(),
                         ['klicnummer','id','registratiedatum','vervaldatum','omschrijving'])

    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact2._Belang_5012613-300',
...
class AppurtenanceTestCase(unittest.TestCase):
    ...
    def test_field_names(self):
        self.assertEqual(self.imkl_obj.field_names(),
                         ['klicnummer', 'id', 'network_id','status', 'validFrom', 'validTo',
    ...
    def test_field_values(self):
        self.maxDiff = None
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.app00001','nl.imkl-nbact1.un00007',
                          'http://inspire.ec.europa.eu/codelist/ConditionOfFacilityValue/disused',
...
class GebiedsinformatieLeveringTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-KA0000._GebiedsinformatieLevering_18G007160-1',
...
class AnnotatieTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.an00001','1996-05-08T00:00:00+02:00',
...
class MaatvoeringTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.mv00002','2001-12-17T09:30:47.0Z',
...
class DiepteTovMaaiveldTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.dmaai00001','2001-12-17T09:30:47',
...
class KastTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.kast00001','nl.imkl-nbact1.un00048',
...
class TechnischGebouwTestCase(unittest.TestCase):

    def setUp(self):
        """
        unit test to test imkl.technischGebouw
        """
        # read the file
        xml_file = open("data/imkl/technischGebouw.xml")
        root = ET.fromstring(xml_file.read())
        self.xml_element = xml_utils.find_xml_with_tag(root, "TechnischGebouw",
                                                       None)
        self.imkl_obj = imkl.technischGebouw()
        self.imkl_obj.process(self.xml_element)
        xml_file.close()
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.tg00001','nl.imkl-nbact1.un00059',
...
_suite_TechnischGebouwTestCase = unittest.TestLoader().loadTestsFromTestCase(TechnischGebouwTestCase)
...
class MangatTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.mgat00001','nl.imkl-nbact1.un00054',
                          'http://inspire.ec.europa.eu/codelist/ConditionOfFacilityValue/disused',
                          '2001-12-17T09:30:47.0Z','2001-12-17T09:30:47.0Z',
...
class MastTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.mast00001','nl.imkl-nbact1.un00056',
                          'http://inspire.ec.europa.eu/codelist/ConditionOfFacilityValue/functional',
                          '2001-12-17T09:30:47.0Z','2001-12-17T09:30:47.0Z',
...
class TorenTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.toren00001','nl.imkl-nbact1.un00076',
                          'http://inspire.ec.europa.eu/codelist/ConditionOfFacilityValue/functional',
                          '2001-12-17T09:30:47.0Z','2001-12-17T09:30:47.0Z',
...
class EigenTopografieTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.et00001','2001-12-17T09:30:47.0Z',
...
class WaterleidingTestCase(unittest.TestCase):

    def setUp(self):
        """
        unit test to test imkl.waterleiding
        """
        # read the file
        xml_file = open("data/imkl/waterleiding.xml")
        root = ET.fromstring(xml_file.read())
        self.xml_element = xml_utils.find_xml_with_tag(root, "Waterleiding",
                                                       None)
        self.imkl_obj = imkl.waterleiding()
        self.imkl_obj.process(self.xml_element)
        xml_file.close()
...
_suite_WaterleidingTestCase = unittest.TestLoader().loadTestsFromTestCase(WaterleidingTestCase)
...
class EVbijlageTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1._EisVoorzorgsmaatregelBijlage_18G007160_gasHogeDruk',
...
class ExtraDetailinfoTestCase(unittest.TestCase):
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact1.edi00001','2015-10-15T09:30:47.0Z',
...
class BeheerderTestCase(unittest.TestCase):

    def setUp(self):
        """
        unit test to test imkl.beheerder
        """
        # read the file
        xml_file = open("data/imkl/beheerder.xml")
        root = ET.fromstring(xml_file.read())
        self.xml_element = xml_utils.find_xml_with_tag(root, "Beheerder",
                                                       None)
        self.imkl_obj = imkl.beheerder()
        self.imkl_obj.process(self.xml_element)
        xml_file.close()
    ...
    def test_field_values(self):
        self.assertEqual(self.imkl_obj.field_values(),
                         [None,'nl.imkl-nbact2._Beheerder',
                          '2000-01-01T00:00:00.000+01:00',None,'nbact2'])

    def test_name_organisation(self):
        orgs = self.imkl_obj.field("organisatie").value
        org = orgs[0]
        field = org.field("naam")
        self.assertEqual(field.value, 'Netbeheerder Actualiseren02')

_suite_BeheerderTestCase = unittest.TestLoader().loadTestsFromTestCase(BeheerderTestCase)

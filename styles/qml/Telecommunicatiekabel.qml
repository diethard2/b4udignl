...
<qgis version="2.14.6-Essen" minimumScale="1" maximumScale="400000" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="utilityFacilityReference">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="toelichting">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{da6a7799-9fd9-4300-8aab-de51640155d1}">
      <rule scalemaxdenom="500" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot;  =  'functional' " key="{ada7f3e8-835c-4216-9aba-5ca0a9c54205}" symbol="0" scalemindenom="1" label="datatransport 1"/>
      <rule scalemaxdenom="500" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'disused' " key="{5ac96037-8d2e-4392-82f4-82391ade568c}" symbol="1" scalemindenom="1" label="datatransport buiten gebruik 1"/>
      <rule scalemaxdenom="500" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'projected' " key="{9813324d-aa37-4a23-bdd3-3f4ecb43a975}" symbol="2" scalemindenom="1" label="datatransport geprojecteerd 1"/>
      <rule scalemaxdenom="500" filter=" &quot;thema&quot;  =  'wees'" key="{b18e8c38-e055-4f72-acc0-578a5c001670}" symbol="3" scalemindenom="1" label="wees 1"/>
      <rule scalemaxdenom="10000" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'functional' " key="{f76a4cbe-24b1-462f-81eb-2fc6cfc57ec2}" symbol="4" scalemindenom="500" label="datatransport 2"/>
      <rule scalemaxdenom="10000" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'disused' " key="{ccb74a61-b871-4fb0-bca3-d731a10ffaef}" symbol="5" scalemindenom="500" label="datatransport buiten gebruik 2"/>
      <rule scalemaxdenom="10000" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'projected' " key="{c6ddea16-75e9-47be-8afa-92ad7d13830b}" symbol="6" scalemindenom="500" label="datatransport geprojecteerd 2"/>
      <rule scalemaxdenom="10000" filter=" &quot;thema&quot;  =  'wees'" key="{0dcdd0b4-90d7-4d10-87ec-516a6ff16939}" symbol="7" scalemindenom="500" label="wees 2"/>
      <rule scalemaxdenom="400000" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'functional' " key="{6ebc4c68-923e-4f6c-b2da-924bef7def47}" symbol="8" scalemindenom="10000" label="datatransport 3"/>
      <rule scalemaxdenom="400000" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'disused' " key="{b6821b42-f18f-4d7b-9b5c-7955046fced7}" symbol="9" scalemindenom="10000" label="datatransport buiten gebruik 3"/>
      <rule scalemaxdenom="400000" filter=" &quot;thema&quot;  =  'datatransport' AND  &quot;status&quot; =  'functional' " key="{35049ef3-1a14-4d40-a09d-24b519362c0a}" symbol="10" scalemindenom="10000" label="datatransport geprojecteerd 3"/>
      ...
      <rule scalemaxdenom="10000" filter=" &quot;thema&quot; IN ('gasLageDruk','gasHogeDruk','buisleidingGevaarlijkeInhoud','landelijkHoogspanningsnet','hoogspanning','middenspanning','laagspanning','petrochemie','rioolVrijverval','rioolOnderOverOfOnderdruk','warmte','water','overig')" key="{49241506-d5f4-44df-9524-c4395127933e}" symbol="12" scalemindenom="1" label="verkeerd thema"/>
    </rules>
    <symbols>
